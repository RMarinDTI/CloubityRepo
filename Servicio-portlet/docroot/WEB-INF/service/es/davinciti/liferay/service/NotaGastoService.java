...
/**
 * Provides the remote service interface for NotaGasto. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Cmes
 * @see NotaGastoServiceUtil
...
public interface NotaGastoService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NotaGastoServiceUtil} to access the nota gasto remote service. Add custom service methods to {@link es.davinciti.liferay.service.impl.NotaGastoServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
