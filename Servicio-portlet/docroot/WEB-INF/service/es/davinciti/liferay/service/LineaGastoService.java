...
/**
 * Provides the remote service interface for LineaGasto. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Cmes
 * @see LineaGastoServiceUtil
...
public interface LineaGastoService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LineaGastoServiceUtil} to access the linea gasto remote service. Add custom service methods to {@link es.davinciti.liferay.service.impl.LineaGastoServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
