...
/**
 * Provides the local service interface for TipoDiaCalendar. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Cmes
 * @see TipoDiaCalendarLocalServiceUtil
...
public interface TipoDiaCalendarLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TipoDiaCalendarLocalServiceUtil} to access the tipo dia calendar local service. Add custom service methods to {@link es.davinciti.liferay.service.impl.TipoDiaCalendarLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
