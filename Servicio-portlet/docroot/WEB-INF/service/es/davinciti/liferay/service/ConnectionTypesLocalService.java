...
/**
 * Provides the local service interface for ConnectionTypes. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Cmes
 * @see ConnectionTypesLocalServiceUtil
...
public interface ConnectionTypesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ConnectionTypesLocalServiceUtil} to access the connection types local service. Add custom service methods to {@link es.davinciti.liferay.service.impl.ConnectionTypesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
