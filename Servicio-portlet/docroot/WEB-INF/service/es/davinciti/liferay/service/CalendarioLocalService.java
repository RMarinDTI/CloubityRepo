...
/**
 * Provides the local service interface for Calendario. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Cmes
 * @see CalendarioLocalServiceUtil
...
public interface CalendarioLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CalendarioLocalServiceUtil} to access the calendario local service. Add custom service methods to {@link es.davinciti.liferay.service.impl.CalendarioLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
