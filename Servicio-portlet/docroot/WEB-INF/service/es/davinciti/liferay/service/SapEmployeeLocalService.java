...
/**
 * Provides the local service interface for SapEmployee. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Cmes
 * @see SapEmployeeLocalServiceUtil
...
public interface SapEmployeeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SapEmployeeLocalServiceUtil} to access the sap employee local service. Add custom service methods to {@link es.davinciti.liferay.service.impl.SapEmployeeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
