 ...
 * @generated
 */
public abstract class LineaGastoCategoriaActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public LineaGastoCategoriaActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(LineaGastoCategoriaLocalServiceUtil.getService());
		setClass(LineaGastoCategoria.class);

		setClassLoader(es.davinciti.liferay.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("categoriaId");
	}
}